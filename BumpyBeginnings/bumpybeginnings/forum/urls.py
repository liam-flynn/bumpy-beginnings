...
urlpatterns = [
    ...
    path('forums/<int:forum_id>/deactivate/', views.deactivate_forum, name='deactivate_forum'),
    path('forums/<int:forum_id>/reactivate/', views.reactivate_forum, name='reactivate_forum'),
    path('<int:pk>/', ForumDetailView.as_view(), name='forum_detail'),
    path('<int:forum_id>/posts/<int:pk>/', PostDetailView.as_view(), name='post_detail'),
